...
// Source: "New Hope Website Data.docx" (client-supplied). Only content present
// in that document is used here; anything the document does not provide (contact
// details, meeting times, photos) is left as PENDING and shown as a placeholder.
// ---------------------------------------------------------------------------
